...
class Pdf2images:
    ...
    def converter(self):
        ...
        try:
            os.makedirs('{}/media/audiobook_books/{}/images/{}'.format(
                self.pdfpath, self.pdfname, self.chapter_name), exist_ok=True)
        except FileExistsError:
            pass

        for i in range(self.start, self.end + 1):
            self.pages[i].save('{}/media/audiobook_books/{}/images/{}/page{}.jpg'.format(self.pdfpath, self.pdfname,
...
# 	pages = convert_from_path("{}/pdf2audiobook/media/books/{}.pdf".format(pdfpath, pdfname))
...
#     a = Pdf2images(name_of_pdf, index_keys[x], int(
#         index_values[x][0]), int(index_values[x][1]), pdf_pages)
#     a.converter()
# f = open('{}/pdf2audiobook/media/audiobook_books/{}/Index.txt'.format(
#     os.path.dirname(__file__), name_of_pdf), 'w')
# f.write(str(Index))
# f.close()

# os.chmod('{}/pdf2audiobook/media/audiobook_books/{}/Index.txt'.format(
#     os.path.dirname(__file__), name_of_pdf), S_IREAD)
